...
namespace Microsoft.WindowsAzure.Commands.Storage.Test.Table
{
    ...
    public class StorageTableStorageTestBase : StorageTestBase
    {
        ...
        public void AddTestTables()
        {
            ...
            tableMock.tableList.Add(new CloudTable(new Uri(testUri), tableClient.Credentials));
            tableMock.tableList.Add(new CloudTable(new Uri(textUri), tableClient.Credentials));
        }
    }
}
