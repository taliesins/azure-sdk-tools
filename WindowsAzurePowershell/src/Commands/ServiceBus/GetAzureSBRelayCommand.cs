...
namespace Microsoft.WindowsAzure.Commands.ServiceBus
{
    ...
    public class GetAzureSBRelayCommand : CmdletWithSubscriptionBase
    {
        internal ServiceBusClientExtensions Client { get; set; }

        [Parameter(Position = 0, Mandatory = false, ValueFromPipelineByPropertyName = true, HelpMessage = "The relay name")]
